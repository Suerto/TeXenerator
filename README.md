...
```bash
pdflatex -interaction=nonsstopmode -halt-on-error verbale_2025-11-15.tex &&  pdflatex -interaction=nonstopmode -halt-on-error verbale_2025-11-15.tex && rm *.out *.log *.toc *.aux
